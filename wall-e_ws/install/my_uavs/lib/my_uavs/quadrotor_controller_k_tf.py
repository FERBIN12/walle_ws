...
The k gain used by the controller is a ros-param to be modified at runtime.
...
$ ros2 run my_uavs quadrotor_controller_k_tf.py --ros-args -r __ns:=/r1
	# Runs this node. NOTE: Do not run this node within a launch file

$ rviz2 -d ~/colcon_ws/src/my_uavs/rviz/one_drone.rviz
  # Open Rviz with my configuration file to visualize paths (optional)
...
class TrajControl(Node):
    ...
    def __init__(self):
        super().__init__('quadrotor_controller_k_tf') # class’s constructor
